package it.nowicki.jaroslaw.socialnetwork.backend.domain.notification.aspect

import it.nowicki.jaroslaw.socialnetwork.backend.domain.comment.Comment
import it.nowicki.jaroslaw.socialnetwork.backend.domain.notification.NotificationService
